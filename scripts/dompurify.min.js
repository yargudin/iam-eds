...
!(function (e, t) {
    ...
    var re = (function t() {
                ...
                if (!ft || ft !== e) {
                    if (
                        ...
                        (Ve = _(e, 'ADD_DATA_URI_TAGS')
                            ...
                            : Ze),
                        ($e = _(e, 'FORBID_CONTENTS')
                            ? w({}, e.FORBID_CONTENTS, pt)
                            : Ke),
                        (ve = _(e, 'FORBID_TAGS')
                            ? w({}, e.FORBID_TAGS, pt)
                            : {}),
                        ...
                        qe &&
                            ...
                            !0 === qe.svgFilters &&
                                (w(Ne, x), w(we, P), w(we, F)),
                            !0 === qe.mathMl && (w(Ne, k), w(we, H), w(we, F))),
                        e.ADD_TAGS &&
                            (Ne === Re && (Ne = D(Ne)), w(Ne, e.ADD_TAGS, pt)),
                        e.ADD_ATTR &&
                            (we === Oe && (we = D(we)), w(we, e.ADD_ATTR, pt)),
        ...
        const wt = function (e) {
                let t = null;
                if ((Rt(de.beforeSanitizeElements, e, null), bt(e)))
                    return (Et(e), !0);
                        ...
                        !(
                            (Dt(e) &&
                                ...
                                ((De.attributeNameCheck instanceof RegExp &&
                                    ...
                                    (De.attributeNameCheck instanceof
                                        Function &&
            ...
            Lt = function e(t) {
                ...
                const o = St(t);
                for (
                    Rt(de.beforeSanitizeShadowDOM, t, null);
                    (n = o.nextNode());
                )
        ...
        return (
            (o.sanitize = function (e) {
                ...
                if (Fe) {
                    ...
                    return (
                        (we.shadowroot || we.shadowrootmode) &&
                            (l = fe.call(a, l, !0)),
                        l
                    );
                }
